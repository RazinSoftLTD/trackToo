...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::prefix('payroll')->group(function () {
        Route::get('/verify-authorization', [PayrollController::class, 'passAuthKey'])->name('payroll.pass_auth_key');
        Route::post('/verify-authorization', [PayrollController::class, 'setPayrollAuthKey'])->name('payroll.set_auth_key');
        
        Route::post('/generate', [PayrollController::class, 'generatePaySlip'])->name('payroll.generate_pay_slip');
        Route::post('/updateStatus', [PayrollController::class, 'updateStatus'])->name('payroll.update_status');
        Route::get('/get-status', [PayrollController::class, 'getStatus'])->name('payroll.get_status');
        Route::get('/download/{id}', [PayrollController::class, 'downloadPdf'])->name('payroll.download_pdf');
        Route::post('/get-cycle-data', [PayrollController::class, 'getCycleData'])->name('payroll.get-cycle-data');
        Route::post('/get_expense_title', [PayrollController::class, 'getExpenseTitle'])->name('payroll.get_expense_title');
        Route::get('/get_employee/{payrollCycle?}/{departmentId?}', [PayrollController::class, 'byDepartment'])->name('payroll.get-employee');
    ...
    Route::resource('payroll', PayrollController::class)->middleware('check-auth');
